...
Note: These are the pin assignments when using the I2S interface to the LCD display. You are on the main branch of this repository. If using the I2S interface, refer to the `parallel_interface` branch.
